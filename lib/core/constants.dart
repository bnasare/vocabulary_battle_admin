...
class AppColors {
  ...
  /// Letter colors for battle mode
  static const List<Color> letterColors = [
    Color(0xFF3B82F6), // Blue - First letter
    Color(0xFF10B981), // Green - Second letter
    Color(0xFF8B5CF6), // Purple - Third letter
    Color(0xFFF59E0B), // Orange - Random
  ];
}
